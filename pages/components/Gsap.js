...
export default function Gsap(){
    ...
    useEffect(()=>{
        ...
        .to("#text-0",{autoAlpha:1, y:0, duration: 1.2, ease: "bounce.out"})
        .to("#text-0",{autoAlpha:1, y:125, duration: 0.2, delay:0.5})
        .to("#text-1",{autoAlpha:1, y:0, duration: 1.2, ease: "bounce.out"})
        .to("#text-1",{autoAlpha:1, y:125, duration: 0.2, delay:0.5})
        .to("#text-2",{autoAlpha:1, x:0, duration: 1.2, ease: "back.out(1.7)"})
